...
const Partner = () => {
  return (
    <div>
      {/* Become a Partner */}
      <div className="flex w-full flex-col items-center justify-center space-y-5 bg-[#39BDFF] p-5 md:flex-row md:space-y-0 md:space-x-5">
      ...
      {/* Become a Partner */}
      <div className="flex w-full flex-col items-center justify-center space-y-5 bg-[#76EBC0] p-5 md:flex-row md:space-y-0 md:space-x-5">
